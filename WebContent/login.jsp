...
<link href="/metronic.bootstrap/css/login.css" rel="stylesheet"
	type="text/css" />
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="/metronic.bootstrap/image/logo-big.png" alt="" />
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" method="post" action="/users/login.do">
	...
	<script src="/metronic.bootstrap/js/app.js" type="text/javascript"></script>
	<script src="/metronic.bootstrap/js/login.js" type="text/javascript"></script>
