		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<form action="/orders/update.do" method="post">
					order_name ： <input name="order.oder_name"
						value="${order.oder_name}" /> mobile ： <input name="order.mobile"
						value="${order.mobile}" /> uid ： <input name="order.uid"
						value="${order.uid}" /><input type="submit" value="ok" />
				</form>
				<!-- END PAGE CONTENT-->
			</div>
			<!-- END PAGE CONTAINER-->
