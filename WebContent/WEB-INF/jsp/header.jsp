<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			<!-- BEGIN LOGO -->
			<a class="brand" href="/users/index.do"> <img
				src="/metronic.bootstrap/image/logo.png" alt="logo" /> </a>
			<!-- END LOGO -->
			<!-- BEGIN RESPONSIVE MENU TOGGLER -->
			<a href="javascript:;" class="btn-navbar collapsed"
				data-toggle="collapse" data-target=".nav-collapse"> <img
				src="/metronic.bootstrap/image/menu-toggler.png" alt="" /> </a>
			...
			<ul class="nav pull-right">
				...
				<li class="dropdown" id="header_notification_bar"><a href="#"
					...
					<ul class="dropdown-menu extended notification">
						<li>
							<p>You have 14 new notifications</p></li>
				...
				<li class="dropdown" id="header_inbox_bar"><a href="#"
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="/metronic.bootstrap/image/avatar1.jpg" alt="" /> </span> <span
						...
						<li class="external"><a href="inbox.html">See all
								messages <i class="m-icon-swapright"></i> </a></li>
					</ul></li>
				<!-- END INBOX DROPDOWN -->
				<!-- BEGIN TODO DROPDOWN -->
				...
				<li class="dropdown user"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li><a href="#"><i class="icon-tasks"></i> My Tasks</a>
						</li>
						<li class="divider"></li>
